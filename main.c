...
int start(){
   ...
   cls();
   setMonitorColor(0x07);

   char FirstMain[] = "FLIP-OS: VERSION 1.0.0.0\n";
   char FirstCLI[] = "FLIP-OS Team. All rights reserved (c)\n\n";
   char OSdescrip[] = "FLIP-OS > ";

   printString(FirstMain);
   printString(FirstCLI);
   printColorString(OSdescrip , 0x0f);
